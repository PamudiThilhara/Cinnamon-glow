  ...
  <div style="padding:5rem 3rem;max-width:1200px;margin:0 auto;">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(250px,1fr));gap:1.5rem;">
      <div v-for="p in filtered" :key="p.id" style="background:white;border-radius:8px;overflow:hidden;box-shadow:0 2px 16px rgba(107,45,15,0.08);">
        <img :src="p.image" :alt="p.name" style="width:100%;height:230px;object-fit:cover;" />
...
const products = [
  { id:1,  name:'Toasted Cinnamon Body Oil',  category:'Body', price:38, image:'https://picsum.photos/seed/p1/400/300' },
  { id:2,  name:'Crimson Rose Lip Stain',      category:'Lips', price:24, image:'https://picsum.photos/seed/p2/400/300' },
  { id:3,  name:'Melanin-Boost Serum',         category:'Face', price:52, image:'https://picsum.photos/seed/p3/400/300' },
  { id:4,  name:'Spiced Vanilla Blush',        category:'Face', price:28, image:'https://picsum.photos/seed/p4/400/300' },
  { id:5,  name:'Deep Brown Mascara',          category:'Eyes', price:18, image:'https://picsum.photos/seed/p5/400/300' },
  { id:6,  name:'Golden Hour Highlighter',     category:'Face', price:32, image:'https://picsum.photos/seed/p6/400/300' },
  { id:7,  name:'Berry Lip Gloss',             category:'Lips', price:16, image:'https://picsum.photos/seed/p7/400/300' },
  { id:8,  name:'Cinnamon Brow Pencil',        category:'Eyes', price:14, image:'https://picsum.photos/seed/p8/400/300' },
  { id:9,  name:'Rose Gold Eye Shadow',        category:'Eyes', price:26, image:'https://picsum.photos/seed/p9/400/300' },
  { id:10, name:'Warm Nude Foundation',        category:'Face', price:45, image:'https://picsum.photos/seed/p10/400/300' },
  { id:11, name:'Cinnamon Lip Liner',          category:'Lips', price:12, image:'https://picsum.photos/seed/p11/400/300' },
  { id:12, name:'Glow Body Butter',            category:'Body', price:34, image:'https://picsum.photos/seed/p12/400/300' },
]
